<?php
	...
	if ($in_codetables->validate_codetable($page->codetable)) {
		...
		if (file_exists(__DIR__."/min-code-table-$page->codetable.php")) {
			...
			$page->js   .= $config->twig->render("code-tables/min/$page->codetable/js.twig", ['page' => $page, 'max_length_code' => $module_codetable->get_max_length_code(), 'm_in' => $module_codetable]);
		}
	} else {

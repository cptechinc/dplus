<?php
	if ($input->get->sysop) {
		...
		$page->body .= $config->twig->render('code-tables/edit-code-modal.twig', ['page' => $page, 'file' => "map/$page->codetable/form.twig", 'sysop' => $sysopcode, 'max_length_code' => SysopOptionalCode::MAX_LENGTH_CODE]);
		$page->js   .= $config->twig->render("code-tables/map/$page->codetable/js.twig", ['page' => $page, 'sysop' => $sysopcode, 'max_length_code' => SysopOptionalCode::MAX_LENGTH_CODE, 'm_aoptm' => $module_codetable]);
	} else {

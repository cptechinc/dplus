	...
	$routes  = [
		...
		'msa' => [
			'validate' => [
				...
				['GET', 'lgrp/code/', Json\Msa::class, 'validateLgrp'],
				['GET', 'loginid/', Json\Msa::class, 'validateUserid'],
				['GET', 'lrole/id/', Json\Msa::class, 'validateRoleid'],
				...
				['GET', 'printer/id/', Json\Msa::class, 'validatePrinter'],
				'sysop' => [
			...
			['GET', 'lgrp/code/', Json\Msa::class, 'getLgrp'],
			['GET', 'lrole/role/', Json\Msa::class, 'getRole'],
			['GET', 'noce/', Json\Msa::class, 'getNoceNote'],
			['GET', 'printer/', Json\Msa::class, 'getPrinter'],
			'sysop' => [

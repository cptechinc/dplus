<?php
	if ($input->get->sysop) {
		...
		$page->body .= $config->twig->render('code-tables/edit-code-modal.twig', ['page' => $page, 'file' => "mso/$page->codetable/form.twig", 'max_length_code' => SysopOptionalCode::MAX_LENGTH_CODE]);
		$page->js   .= $config->twig->render("code-tables/mso/$page->codetable/js.twig", ['page' => $page, 'sysop' => $sysopcode, 'max_length_code' => SysopOptionalCode::MAX_LENGTH_CODE]);
	} else {

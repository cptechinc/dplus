<?php
	...
	if ($customerquery->count()) {
		...
		if ($module_json->file_exists(session_id(), $page->jsoncode)) {
			...
			$page->body .= $config->twig->render('customers/ci/customer/quotes.twig', ['page' => $page, 'custID' => $custID, 'json' => $json, 'module_formatter' => $module_formatter, 'blueprint' => $module_formatter->get_tableblueprint()]);
		} else {

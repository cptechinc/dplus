<?php
	...
	if ($itemquery->count()) {
		...
		if ($module_json->file_exists(session_id(), $page->jsoncode)) {
			...
			$page->body .= $config->twig->render('items/ii/ii-links.twig', ['page' => $page, 'itemID' => $itemID, 'lastmodified' => $module_json->file_modified(session_id(), $page->jsoncode), 'refreshurl' => $refreshurl]);$page->body .= $config->twig->render('items/ii/lotserial/lotserial.twig', ['page' => $page, 'json' => $json, 'module_json' => $module_json]);
		} else {

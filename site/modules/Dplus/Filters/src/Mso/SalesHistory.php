...
use SalesHistoryQuery, SalesHistory as SalesHistoryClass;
...
============================================================= */
	...
	public function _search($q) {
		$columns = [
			SalesHistoryClass::get_aliasproperty('contactid'),
			SalesHistoryClass::get_aliasproperty('title'),
		];
...
============================================================= */
	 ...
	 * @param  SalesHistoryClass $item SalesHistory
	 * @return int
	 */
	public function position(SalesHistoryClass $p) {

<?php namespace Dplus\Filters\Mpm;
// Dplus Model
use PrResourceQuery, PrResource as Model;
// ProcessWire Classes
...
/**
* Wrapper Class for PrResourceQuery
*/
class PrResource extends AbstractFilter {
...
============================================================= */
	 ...
	 * @param  Model|string $item PrResource|Code
	 * @return int
	 */
